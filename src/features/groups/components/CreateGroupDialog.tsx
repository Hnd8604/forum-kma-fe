          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                >
                  <div className={`p-2 rounded-full ${privacy === 'PUBLIC' ? 'bg-red-100 text-red-600' : 'bg-slate-100 text-slate-500'
                    }`}>
                    <Globe className="w-4 h-4" />
                  </div>
                  <div>
                    <div className={`font-semibold text-sm ${privacy === 'PUBLIC' ? 'text-red-900' : 'text-slate-700'
                      }`}>Công khai</div>
                ...
                >
                  <div className={`p-2 rounded-full ${privacy === 'PRIVATE' ? 'bg-red-100 text-red-600' : 'bg-slate-100 text-slate-500'
                    }`}>
                    <Lock className="w-4 h-4" />
                  </div>
                  <div>
                    <div className={`font-semibold text-sm ${privacy === 'PRIVATE' ? 'text-red-900' : 'text-slate-700'
                      }`}>Riêng tư</div>
