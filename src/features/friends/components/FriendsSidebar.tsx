      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-4 shadow-sm">
        ...
        <div className="space-y-2.5">
          <div className="flex items-center justify-between">
            <span className="text-sm text-slate-600">Tổng số bạn bè</span>
            <span className="font-semibold text-slate-900">{friends.length}</span>
          </div>
          <div className="flex items-center justify-between">
            <span className="text-sm text-slate-600">Đang online</span>
            <span className="font-semibold text-green-600 flex items-center gap-1">
              <span className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></span>
              {Math.min(friends.length, Math.ceil(friends.length * 0.6))}
            </span>
          </div>
          <div className="flex items-center justify-between">
            <span className="text-sm text-slate-600">Lời mời đang chờ</span>
            <span className="font-semibold text-orange-600">{receivedRequests.length}</span>
          </div>
        </div>
      </div>
